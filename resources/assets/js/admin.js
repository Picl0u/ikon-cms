...
jQuery(document).ready(function(){
    ...
    // DropDown
    require("../vendors/dropdown/dropdown");
    // DataTable
    ...
    // Sortable - simple
    if(jQuery(".simple-sortable").length > 0) {
        require('./components/admin/sortable');
        var $sort = jQuery('.simple-sortable');
        var $uri = jQuery(".nested-section").attr("data-url");
    ...
    if(jQuery(".dashboard-date").length > 0) {
        var updateClock = function()
        {
            ...
            jQuery(".clock").html('<i class="fa fa-clock-o" aria-hidden="true"></i> ' + currentTimeString);
